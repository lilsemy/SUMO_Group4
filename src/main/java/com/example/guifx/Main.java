...
public class Main extends Application {
  ...
  public void start(Stage stage) throws Exception {
    ...
    /**
     * Because I set the stage to maximized First it appear correctly but after load the all the
     * layer it start to bug The info panel is overflow to the right This is a quick fix - call
     * maximized later
     */
